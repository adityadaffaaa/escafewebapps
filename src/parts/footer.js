...
import ButtonDaftar from "../components/buttonDaftarSekarang";
import logo from "../assets/LOGO ESCAFE.png";
const Footer = () => {
  return (
    <footer className="mt-[100px]">
      <div className="bg-secondary w-full h-[330px] rounded-t-[32px] flex justify-center items-center">
        <div className="flex flex-row w-4/5 justify-between">
          <div className="flex flex-col gap-3 items-center">
            <img className="w-20" src={logo} alt="" />
            <div className="flex flex-row gap-3">
              <a className="fill-text2 hover:scale-125 transition-all ease-in-out duration-200" href="/">
          ...
          <div className="flex flex-col gap-3">
            <p className="text-text2 text-paragraph1">Links</p>
            <a className="text-text2 text-paragraph2" href="/">
              Beranda
            </a>
            <a className="text-text2 text-paragraph2" href="/">
              Menu
          ...
          <div className="flex flex-col gap-3">
            <p className="text-text2 text-paragraph1">Tentang</p>
            <a className="text-text2 text-paragraph2" href="/">
              Produk kami
            </a>
            <a className="text-text2 text-paragraph2" href="/">
          ...
          <div className="flex flex-col gap-3">
            <p className="text-text2 text-paragraph1">Sobat kopi</p>
            <a className="text-text2 text-paragraph2" href="/">
              Lorem ipsum
            </a>
            <a className="text-text2 text-paragraph2" href="/">
          ...
          <div className="flex flex-col gap-3 items-start">
            <p className="text-text2 text-paragraph1">Kami berada di</p>
            <p className="text-text2 text-paragraph2 w-[340px]">2HJV+G2V, Jl. Dieng Atas, Sumberjo, Kalisongo, Kec. Dau, Kabupaten Malang, Jawa Timur 65151</p>
            <p className="text-text2 text-paragraph1">Ingin menjadi member?</p>
            {ButtonDaftar()}
          </div>
        </div>
      </div>
      <div className="w-full h-[50px] bg-background2 flex items-center justify-center">
        <p className="text-paragraph4 text-text2">©2022 - ESCAFE (Smart Cafe). All rights reserved.</p>
      </div>
    </footer>
  );
};
